# base-plugins [![NPM version](https://img.shields.io/npm/v/base-plugins.svg)](https://www.npmjs.com/package/base-plugins) [![Build Status](https://img.shields.io/travis/node-base/base-plugins.svg)](https://travis-ci.org/node-base/base-plugins)
